        ...
        2607: (e, t) => {
            ...
            class LoadMore extends elementorModules.frontend.handlers.Base {
                ...
                handleSuccessFetch(e) {
                    ...
                    s.forEach((e => this.elements.postsContainer.append(e))), this.elements.loadMoreAnchor.setAttribute("data-page", this.currentPage), this.elements.loadMoreAnchor.setAttribute("data-next-page", n), this.currentPage === this.maxPage && this.handleUiWhenNoPosts(), this.afterInsertPosts(s, e)
                }
                handlePostsQuery() {
